...
const Home = () => {
	...
	const fetchTasks = () => {
		fetch('https://playground.4geeks.com/todo/users/Luis')  // Asegúrate de que esta URL sea correcta
			.then(response => {
				if (!response.ok) {
	...
	const addTask = (task) => {
		...
		fetch('https://playground.4geeks.com/todo/todos/Luis', {  // Usa POST para agregar tareas
			method: 'POST',
			mode: 'cors',
			headers: {
	...
	const clearAllTasks = () => {
		fetch('https://playground.4geeks.com/todo/users/Luis', {
			method: 'DELETE',
			headers: {
				"Content-Type": "application/json"
			}
	...
	return (
		<div className="app-container d-flex flex-column">
			<div className="heading">Tareas de Luis</div>
			<div className="p-0 mb-2 form-container3">
			<div className="p-0 mb-2 form-container2">
			<div className="form-container">
				...
				<button onClick={clearAllTasks} className="button">
					<span className='text-clear'> Limpiar las tareas </span>
				</button>
			</div>
			</div>
			</div>
